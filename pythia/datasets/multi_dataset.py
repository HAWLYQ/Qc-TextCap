...
class MultiDataset:
    ...
    def load(self, **opts):
        ...
        # print('pythia/datasets/multi_dataset.py self._given_datasets', self._given_datasets) # ['m4c_textcaps']
        for dataset in self._given_datasets:
            # <class 'pythia.datasets.captioning.m4c_textcaps.builder.M4CTextCapsBuilder'>
            builder_class = registry.get_builder_class(dataset)
            # print('pythia/datasets/multi_dataset.py builder_class', builder_class)
            ...
            # print('pythia/datasets/multi_dataset.py builder_instance', builder_instance)
    ...
    def build_dataloader(self, dataset, opts):
        ...
        # print('pythia/datasets/multi_dataset.py other_args', other_args)  # {'shuffle': xxx, 'batch_size': xx}
        loader = DataLoader(
            dataset=dataset,
    ...
    def _add_extra_args_for_dataloader(self, dataset, opts, other_args={}):
        ...
        # anwenhu 2020/11/13 shuffle=False for train set, debug
        # print('multi_dataset.py, training set not shuffle for debug')
