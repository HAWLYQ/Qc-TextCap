    ...
    def _init_reader(self):
        if self.ndim == 2 or self.ndim == 0:
            if self.max_features is None:
                # print('pythia/datasets/feature_readers.py FasterRCNNFeatureReader')
                ...
                #         )
                # else:
                # print('pythia/datasets/feature_readers.py PaddedFasterRCNNFeatureReader')
    ...
    def read(self, image_feat_path):
        ...
        if self.feat_reader is None:
            if self.ndim is None:
                ...
                self.ndim = feat.ndim
            # print('pythia/datasets/feature_readers.py self.ndim', self.ndim) # 2
            self._init_reader()
...
class PaddedFasterRCNNFeatureReader:
    ...
    def read(self, image_feat_path):
        ...
        if self.take_item:  # false for captioning(textcaps/vizwiz)
            item = content.item()
        ...
        # print('pythia/datasets/feature_readers.py image_feature,shape', image_feature.shape)
