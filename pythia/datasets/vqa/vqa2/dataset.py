...
class VQA2Dataset(BaseDataset):
    def __init__(self, dataset_type, imdb_file_index, config, *args, **kwargs):
        ...
        if hasattr(self.config, "image_features"):
            ...
            curr_image_features_dir = all_image_feature_dirs[imdb_file_index]  # train: 0; both ocr and obj dir
            # print('pythia/datasets/vqa/vqa2/dataset.py cuur_image_features_dir', curr_image_features_dir)
