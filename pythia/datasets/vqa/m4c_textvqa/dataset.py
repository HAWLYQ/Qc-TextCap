...
class M4CTextVQADataset(TextVQADataset):
    ...
    def add_sample_details(self, sample_info, sample):
        ...
        sample.text_len = processed_question['token_num'] # value = 1
        # print('m4c_textvqa\dataset.py(line 113):', sample.text, sample.text_len.item())
        # exit(0)
    ...
    def add_answer_info(self, sample_info, sample):
        ...
        if sample_has_answer:
            ...
            sample.targets = processed_answers["answers_scores"]  # max_decoding_step * vocab_size
